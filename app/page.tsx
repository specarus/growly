...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen xl:pt-24 2xl:pt-28 xl:pb-12 2xl:pb-16 bg-linear-to-b from-white/90 via-light-yellow/55 to-green-soft/15 overflow-hidden">
      {showModal && (
        <div
      ...
      <section className="relative z-10 2xl:px-28 xl:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1 xl:text-xs 2xl:text-sm text-muted-foreground shadow-sm ring-1 ring-black/5">
              <span>Growly - Habit tracker for real life</span>
            </div>

            <div className="space-y-5">
              <h1 className="xl:text-5xl 2xl:text-6xl font-semibold text-foreground leading-tight">
                Build habits that survive busy days.
              </h1>
              <p className="xl:text-base 2xl:text-lg text-muted-foreground max-w-2xl">
            ...
            {session ? (
              <div className="flex flex-row gap-4 items-center">
                <Link
                  href="/dashboard"
                  className="xl:text-sm 2xl:text-base w-auto xl:px-5 2xl:px-6 xl:py-2 2xl:py-3 rounded-full bg-primary text-white font-semibold shadow-lg shadow-primary/30 hover:-translate-y-0.5 transition-all inline-flex items-center justify-center gap-2"
                >
                  Go to dashboard
            ...
            <div className="flex flex-wrap items-center gap-4 xl:text-xs 2xl:text-sm text-muted-foreground">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-white/60 bg-white/80 backdrop-blur shadow-xl p-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded-full bg-coral/15 text-coral-foreground xl:text-xs 2xl:text-sm font-semibold">
                  +24 XP
                </span>
              </div>
              ...
              <div className="rounded-2xl bg-analytics-dark text-white p-5 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="xl:text-xs 2xl:text-sm text-green-soft-foreground">
                    On track
                  </span>
                </div>
                <div className="flex gap-2">
                  {["Read 10 pages", "Hydrate", "Plan tomorrow"].map(
                    (habit) => (
                      <div
                        key={habit}
                        className="flex-1 rounded-xl bg-white/10 px-3 py-2 xl:text-xs 2xl:text-sm"
                      >
                        {habit}
                      </div>
                    )
                ...
                <div className="flex items-center gap-2 xl:text-xs 2xl:text-sm text-white/70">
                  <Flame className="h-4 w-4 text-coral" />
      ...
      <section className="relative z-10 2xl:px-28 xl:px-8 xl:mt-14 2xl:mt-16">
        <div className="flex flex-col gap-10 bg-white/80 backdrop-blur border border-white/70 shadow-lg rounded-3xl xl:p-10 2xl:p-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div className="space-y-3">
              <p className="xl:text-sm 2xl:text-base uppercase tracking-[0.2em] text-muted-foreground">
                Why Growly
              </p>
              <h2 className="xl:text-2xl 2xl:text-3xl font-semibold text-foreground">
                Friendly structure for people who juggle a lot.
              </h2>
              <p className="text-muted-foreground xl:max-w-xl 2xl:max-w-2xl xl:text-sm 2xl:text-base">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {highlights.map(({ title, description, icon: Icon }) => (
              <div
                key={title}
                className="group rounded-2xl border border-muted bg-linear-to-b from-white to-muted/30 shadow-md xl:p-5 2xl:p-6 space-y-3 hover:-translate-y-1 transition-transform"
              >
      ...
      <section className="relative z-10 2xl:px-28 xl:px-8 px-6 mt-16">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <div className="space-y-4">
            ...
            <h2 className="xl:text-2xl 2xl:text-3xl font-semibold text-foreground max-w-xl">
              A calm flow that respects your time.
            </h2>
            <p className="text-muted-foreground xl:max-w-2xl xl:text-sm 2xl:text-base">
            ...
            <div className="grid gap-4 mt-6">
              {steps.map((step, index) => (
                ...
                >
                  <div className="xl:h-9 2xl:h-10 xl:w-9 2xl:w-10 rounded-2xl bg-primary/15 text-primary font-semibold grid place-items-center">
                    {index + 1}
                  </div>
                  <div className="space-y-1">
          ...
          <div className="rounded-3xl border border-white/70 bg-linear-to-br from-analytics-dark to-analytics-dark/95 text-white xl:p-6 2xl:p-8 shadow-xl space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="xl:text-xs 2xl:text-sm text-white/70">
                  Today&apos;s focus
                </p>
                <p className="xl:text-xl 2xl:text-2xl font-semibold">
                  Deep Work Ritual
                </p>
              </div>
              <span className="px-3 py-1 rounded-full bg-white/10 xl:text-xs 2xl:text-sm">
                45 min block
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="rounded-xl bg-white/10 p-3">
                ...
                <p className="xl:text-lg 2xl:text-xl font-semibold">Balanced</p>
              </div>
              <div className="rounded-xl bg-white/10 p-3">
                <p className="text-xs text-white/70">Streak</p>
                <p className="xl:text-lg 2xl:text-xl font-semibold">Day 8</p>
              </div>
              <div className="rounded-xl bg-white/10 p-3">
                <p className="text-xs text-white/70">Recovery</p>
                <p className="xl:text-lg 2xl:text-xl font-semibold">Enabled</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 2xl:px-28 xl:px-8 px-6 mt-16">
        <div className="rounded-3xl bg-white/90 backdrop-blur border border-white/70 shadow-lg xl:p-6 2xl:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-3">
            <p className="xl:text-sm 2xl:text-base uppercase tracking-[0.2em] text-muted-foreground">
              Ready when you are
            </p>
            <h3 className="xl:text-2xl 2xl:text-3xl font-semibold text-foreground max-w-xl">
              Let&apos;s make the tiny wins add up.
            </h3>
            <p className="text-muted-foreground xl:max-w-2xl xl:text-xs 2xl:text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <Button
              onClick={() => setShowModal(true)}
              className="xl:text-sm 2xl:text-base sm:w-auto xl:px-5 2xl:px-6 xl:py-2 2xl:py-3 bg-primary text-white font-semibold shadow-lg shadow-primary/30 hover:-translate-y-0.5 transition-all"
            >
              Create my routine
              <ArrowRight className="h-4 w-4" />
            </Button>
