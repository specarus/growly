...
export default function PlantBanner() {
  return (
    <div className="relative overflow-hidden rounded-xl border border-gray-100 bg-linear-to-br from-white/90 via-light-yellow/80 to-green-soft/70 shadow-sm xl:p-7 2xl:p-10">
      ...
      <div className="relative z-10">
        <div className="space-y-3">
          <div className="xl:text-xl 2xl:text-2xl font-bold text-foreground">
            <div className="flex xl:pl-10 xl:pr-32 2xl:pr-36 justify-between">
              <div>Plant small</div>
              <div>wins,</div>
            </div>
            <div className="flex xl:pl-14 2xl:pl-4 xl:pr-8 2xl:pr-0 justify-between">
              <div>harvest</div>
              <div>momentum.</div>
            </div>
          </div>
          ...
          <div className="xl:text-xs 2xl:text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="flex xl:pl-0 2xl:pl-4 xl:pr-6 2xl:pr-12 justify-between">
              <div>The little wins you </div>
              <div>plant today grow</div>
            </div>
            <div className="flex xl:pl-8 2xl:pl-12 xl:pr-8 2xl:pr-6 justify-between">
              <div>routines that</div>
              <div>sustain tomorrow.</div>
            </div>
          </div>

          <div className="flex justify-between gap-2 xl:text-[10px] 2xl:text-[11px] font-semibold">
        ...
        <div className="absolute xl:top-[-52] 2xl:top-[-96] xl:left-[-12] w-full select-none pointer-events-none">
          <Image
            src="/plant.png"
            width={400}
            height={400}
