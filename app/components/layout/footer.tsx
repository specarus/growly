...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t lg:border-b-4 xl:border-b-6 2xl:border-b-8 border-b-primary border-muted/60 bg-card text-foreground shadow-inner shadow-gray-200/40 dark:shadow-none overflow-visible">
