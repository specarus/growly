              ...
              <ModalProvider>
                <div className="min-h-screen flex flex-col text-foreground">
                  ...
                  {session ? (
                    <Link
                      href="/dashboard"
                      className="fixed bottom-5 right-5 z-50 grid place-items-center rounded-full bg-primary xl:p-3 2xl:p-4 font-semibold text-white shadow-lg shadow-primary transition hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
