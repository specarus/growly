...
const IntegrationWidget = () => {
  return (
    <div className="flex flex-col items-center xl:p-2 2xl:p-6 xl:rounded-2xl 2xl:rounded-3xl text-foreground">
      ...
      <Button className="shadow-sm shadow-green-soft hover:shadow-none bg-foreground hover:bg-foreground/90 text-background xl:h-9 2xl:h-11 xl:text-sm 2xl:text-base transition-all duration-200">
