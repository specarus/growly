...
const Todo: FC<TodoProps> = ({
  ...
  return (
    <div className="relative flex items-start gap-3 select-none hover:opacity-80 border border-muted-foreground/5 xl:p-2 2xl:p-3 shadow-inner hover:shadow-none transition rounded-2xl">
      <Link
        href={href || "#"}
