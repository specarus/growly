...
const EditRoutinePage: React.FC<EditRoutinePageProps> = ({
  routineId,
  initialName,
  initialAnchor,
  initialNotes,
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      ...
      try {
        ...
        console.error("Unable to update routine", error);
        setStatus({
    ...
    <main className="relative overflow-hidden w-full min-h-screen xl:pt-24 2xl:pt-28 text-foreground xl:pb-12 2xl:pb-16 bg-linear-to-t from-white/90 via-light-yellow/55 to-green-soft/15">
      ...
      <div className="xl:px-8 2xl:px-28 space-y-8">
        <PageHeading
          ...
          description="Retune the anchor, notes, and stacked habits that keep this layout grounded."
          actions={
        ...
        <div className="grid xl:grid-cols-[1.2fr_0.8fr] gap-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                {isSubmitting ? "Saving routine…" : "Save changes"}
              </Button>
            </div>
          </form>
