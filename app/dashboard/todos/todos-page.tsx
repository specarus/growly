...
const TodosPage: React.FC<TodosPageProps> = ({
  ...
  return (
    <>
      <main className="relative w-full min-h-screen xl:pt-24 2xl:pt-28 text-foreground pb-16 overflow-hidden bg-linear-to-b from-white via-light-yellow/60 to-green-soft/10">
                      ...
                      <div className="flex items-end justify-between gap-6">
                        ...
                        <div className="text-[11px] text-muted-foreground">
                          <p className="whitespace-nowrap">
                            {focusStats.completed} completed •{" "}
                            {focusStats.missed} missed
                          </p>
                            ...
                            <div className="max-h-44 overflow-auto space-y-2 pr-1">
                              {availableTodos.length === 0 ? (
                                ...
                                filteredCreationTodos.map((todo) => {
                                  const checked =
                                    newCollection.todoIds.includes(todo.id);
                                  return (
                                    <label
                                      key={todo.id}
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-3">
                          {collections.length === 0 ? (
                            <div className="sm:col-span-2 lg:col-span-3 2xl:col-span-4 rounded-2xl border border-dashed border-gray-200 bg-white/60 px-4 py-6 text-sm text-muted-foreground">
                              No collections yet.<br></br>Add a name,
                              description, and select todos to start grouping.
                            </div>
                          ) : (
