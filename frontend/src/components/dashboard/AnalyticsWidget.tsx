            ...
            <div className="flex items-center xl:gap-2">
              <div className="flex gap-3 border-[1px] border-gray-50 shadow-sm rounded-full">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full xl:h-8 xl:w-8 2xl:h-10 2xl:w-10 bg-white border-gray-100 border-[1px]"
                >
              ...
              <div className="relative xl:w-32 2xl:w-40" ref={dropdownRef}>
                <div
                  ...
                  className="select-none relative z-20 rounded-full cursor-pointer flex items-center justify-between gap-2 bg-white border border-gray-50 shadow-md xl:text-xs 2xl:text-sm sm:rounded-full xl:px-4 py-2 2xl:px-6"
                >
                  <p>{month}</p>
                  <ChevronDown className="xl:w-3.5 xl:h-3.5 2xl:w-4 2xl:h-4" />
                </div>

                <div
                  className={`absolute w-full border border-gray-50 xl:top-4 2xl:top-5 left-0 shadow-lg overflow-y-auto bg-white rounded-b-2xl xl:pt-4 2xl:pt-2 z-10 transition-all duration-300 ease-in-out ${
                    open
