...
const ScoreWidget = ({
  ...
  return (
    <div className=" bg-white xl:p-3 2xl:p-4 rounded-2xl shadow-none border-none">
      ...
      <div className="flex flex-col xl:gap-3 2xl:gap-4">
        <div className="flex items-center justify-between">
          <div className="flex flex-col items-center xl:px-3 xl:py-2 2xl:px-4 2xl:py-3 rounded-lg bg-secondary/50 text-primary">
        ...
        <div className="w-full flex xl:px-8 2xl:px-10 justify-between rounded-lg">
          ...
          <div className="flex flex-col items-center gap-1">
            <CircularProgress
              ...
              progressColor="rgb(234 179 8)" // yellow-500 for streak
